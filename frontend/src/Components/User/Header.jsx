...
function Header() {
  ...
  return (
    <header>
      <div className="navbar-color relative h-14 flex justify-between sm:justify-end items-center">
      ...
      <div className={`absolute bg-white left-0 top-[10%] w-full items-center px-5 ${isMenuOpen ? "min-h-[35vh]" : "md:min-h-fit"}`}>
        <MdOutlineMenu
